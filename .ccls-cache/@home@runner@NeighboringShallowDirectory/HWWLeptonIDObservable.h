...
private:
  static bool cmp1 (std::tuple<std::string, int, float> a, std::tuple<std::string, int, float> b);
  static bool cmp2 (std::tuple<std::string, std::string, int, float> a, std::tuple<std::string,std::string, int, float> b);
