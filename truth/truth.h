...
private:
  ...
  //TTree *m_myTree;
  //TH1 *m_myHist;
  std::vector<float> *m_Hpt = nullptr;
  std::vector<float> *m_Hupt = nullptr;
  std::vector<float> *m_nmuon = nullptr;
  std::vector<float> *m_jet1_pt = nullptr;
  std::vector<float> *m_muon1_pt = nullptr;
  std::vector<float> *m_muon2_pt = nullptr;
  std::vector<float> *m_muon3_pt = nullptr;
