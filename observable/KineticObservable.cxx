#include "HWWAnalysisCode/KineticObservable.h"
#include <limits>
...
ClassImp(KineticObservable)

//______________________________________________________________________________________________
KineticObservable::KineticObservable()
{
  // default constructor
...
//#include "xAODParticleEvent/CompositeParticleContainer.h"
//______________________________________________________________________________________________
double KineticObservable::getValue() const {
...
//1st loop
  DEBUGclass("============================ KineticObservable info start ===============================");
  float sumPt_SRjet=0;
...
//1st loop
  ...
  TLorentzVector interested_obj(dvalue,dvalue,dvalue,dvalue);

  switch (finterested_obj) {
    case Interested_Obj::miss: 
        interested_obj = miss;
        break;
    case Interested_Obj::Hlep: 
        interested_obj = Hlep;
        break;
    case Interested_Obj::VWlep: 
        interested_obj = VWlep;
        break;
    case Interested_Obj::Zlep1: 
        interested_obj = Zlep1;
        break;
    case Interested_Obj::Zlep2: 
        interested_obj = Zlep2;
        break;
    case Interested_Obj::ZBoson: 
        interested_obj = ZBoson;
        break;
    case Interested_Obj::Hfatjet: 
        interested_obj = Hfatjet;
        break;
    case Interested_Obj::HBoson: 
        interested_obj = HBoson;
        break;
    case Interested_Obj::all_vis: 
        interested_obj = all_vis;
        break;
    case Interested_Obj::jet1: 
      interested_obj = jet1;
      break;
    case Interested_Obj::l1Wjj: 
      interested_obj = l1Wjj;
      break;
    case Interested_Obj::SRjet1_l1: 
      interested_obj = SRjet1_l1;
      break;
    case Interested_Obj::SRjet2_l1: 
      interested_obj = SRjet2_l1;
      break;
    case Interested_Obj::l2Wjj: 
      interested_obj = l2Wjj;
      break;
    case Interested_Obj::SRjet1_l2: 
      interested_obj = SRjet1_l2;
      break;
    case Interested_Obj::SRjet2_l2: 
      interested_obj = SRjet2_l2;
      break;
    case Interested_Obj::HlWjj: 
      interested_obj = HlWjj;
      break;
    case Interested_Obj::SRjet1_Hl: 
      interested_obj = SRjet1_Hl;
      break;
    case Interested_Obj::SRjet2_Hl: 
      interested_obj = SRjet2_Hl;
      break;
    case Interested_Obj::VlWjj: 
      interested_obj = VlWjj;
      break;
    case Interested_Obj::SRjet1_Vl: 
      interested_obj = SRjet1_Vl;
      break;
    case Interested_Obj::SRjet2_Vl: 
      interested_obj = SRjet2_Vl;
      break;
    default:
        DEBUGclass("In event cut error kinetic.");
        throw std::runtime_error("ERROR in KineticObservable :: unrecognised interested_obj. Check your configuration of this observable.");
  }
  ...
  switch (finterested_variable) {
    case Interested_Variable::pt: 
        rval = interested_obj.Pt()/1000;
        break;
    case Interested_Variable::eta: 
        rval = interested_obj.Eta();
        break;
    case Interested_Variable::phi: 
        rval = interested_obj.Phi();
        break;
    case Interested_Variable::e: 
        rval = interested_obj.E()/1000;
        break;
    case Interested_Variable::m: 
        rval = interested_obj.M()/1000;
        break;
    case Interested_Variable::mT: 
        rval = sqrt(2*sqrt(interested_obj.M()* interested_obj.M()+ interested_obj.Pt()* interested_obj.Pt())*miss.E()*(1-cos(interested_obj.DeltaPhi(miss))))/1000;
        break;
    case Interested_Variable::charge: 
        if (finterested_obj==Interested_Obj::Hlep) rval = Hlep_charge;
        if (finterested_obj==Interested_Obj::VWlep) rval = VWlep_charge;
        break;
    // case Interested_Variable::HWnu_pz_real: 
    //     rval = get_HWnuPt(interested_obj,miss).first;
    //     break;
    // case Interested_Variable::HWnu_pz: 
    //     rval = get_HWnuPt(interested_obj,miss).second/1000;
    //     break;
    default:
...
// TQObservable* KineticObservable::getClone() const  {
...
//   }
  ...
  //   obs = new KineticObservable(*this);
  // }
...
//______________________________________________________________________________________________
bool KineticObservable::initializeSelf(){
  TString CandName = "";
...
//______________________________________________________________________________________________
KineticObservable::KineticObservable(const TString& name,const int interested_obj, const int interested_variable):TQEventObservable(name)
{
  finterested_obj=static_cast<Interested_Obj>(interested_obj);
  finterested_variable=static_cast<Interested_Variable>(interested_variable);
}

bool KineticObservable :: cmp_pt_IParticle (std::tuple<const xAOD::IParticle*, int> a,std::tuple<const xAOD::IParticle*, int> b)
{
    return std::get<0>(a)->pt() > std::get<0>(b)->pt();
}
bool KineticObservable :: cmp_pt_Muon (const xAOD::Muon* a,const xAOD::Muon* b)
{
    return a->pt() > b->pt();
}
bool KineticObservable :: cmp_pt_Electron (const xAOD::Electron* a,const xAOD::Electron* b)
{
    return a->pt() > b->pt();
}
bool KineticObservable :: cmp_pt_TLorentzVector (TLorentzVector a,TLorentzVector b)
{
    return a.Pt() > b.Pt();
}
bool KineticObservable :: cmp_pt_Jet (const xAOD::Jet* a,const xAOD::Jet* b)
{
    return a->pt() > b->pt();
}
